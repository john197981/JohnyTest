/*************************************************************************************
* Title 		: OIBVPoll.java
* Description 	: This is the view object of poll module to store view details to db 				    
 ...
 */
public class OIBVPoll implements Serializable{
	...
	/**
	 * @return Returns the strFmtDt.
	 */
	public String getFmtDt() {
		return strFmtDt;
	}
	/**
	 * @param strFmtDt The strFmtDt to set.
	 */
	public void setFmtDt(String strFmtDt) {
		this.strFmtDt = strFmtDt;
	}
	/**
	...
	/**
	 * @return Returns the strDtCnt.
	 */
	public String getDtCnt() {
		return strDtCnt;
	}
	/**
	 * @param strDtCnt The strDtCnt to set.
	 */
	public void setDtCnt(String strDtCnt) {
		this.strDtCnt = strDtCnt;
	}
	/**
	...
	/**
	 * @return Returns the strImgWidth.
	 */
	public String getImgPer() {
		return strImgPer;
	}
	/**
	 * @param strImgWidth The strImgWidth to set.
	 */
	public void setImgPer(String strImgWidth) {
		this.strImgPer = strImgWidth;
	}
	/**
	...
	/**
	 * @return Returns the strWidth.
	 */
	public String getWidth() {
		return strWidth;
	}
	/**
	 * @param strWidth The strWidth to set.
	 */
	...
	/**
	 * @param strAction The strHidAction to set.
	 */
	public void setAction(String strHidAction) {
		this.strAction = strHidAction;
	}
	/**
