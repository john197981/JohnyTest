/*********************************ASMBVReplyRedirectEdit.java******************* 
 * Title 		: ASMBVReplyRedirectEdit
...
public class ASMBVReplyRedirectEdit implements Serializable  
{
	...
	private ArrayList alCategoryList = null;
	 ...
	 */
	public void setHidUserID(String strUserID) {
	...
	public void setTxtRepliedBy(String strRepliedBy) {
		if (strRepliedBy == null || strRepliedBy.length() <= 66)
			this.strRepliedBy = strRepliedBy;
		else
			this.strRepliedBy = strRepliedBy.substring(0, 66);
	}	
	/**
	...
	/**
	 * @return the alCategoryList
	 */
	public ArrayList getAlCategoryList()
	{
		return alCategoryList;
	}
	/**
	 * @param alCategoryList the alCategoryList to set
	 */
	public void setAlCategoryList(ArrayList alCategoryList)
	{
