/*
 * File name	= ASMFormManagement.java
...
public class ASMFormManagement extends OIBaseActionForm {
	...
	/**
	 * @return Returns the divisionurl.
	 */
	public String getDivisionurl() {
		return divisionurl;
	}
	/**
	 * @param divisionurl The divisionurl to set.
	 */
