...
<html:form action="/asmCreateCategoryAction.do">
				...
				<tr>
					...
					<table width="100%" border="0" cellpadding="1" cellspacing="1"
						...
						<tr align="left" valign="top">
							...
							<html:hidden name="ASMCategoryForm" property="hiddenAction" value="populate" />
							</td>
						</tr>
						<tr>
						<tr height="20"><td colspan="2"></td></tr>
						<td height="35" align="left" class="body_detail_text" colspan="2">
						<a href='<bean:message key="OIFM.contextroot" />/asmCategoryAction.do?hiddenAction=populate'><img
							src='<bean:message key="OIFM.docroot" />/images/but_Cancel.gif'
							border="0" alt = "Cancel"></a>
						
						<a href="javascript:fnSubmit('<bean:message key="OIFM.contextroot" />/asmCreateCategoryAction.do?hiddenAction=save')"><img 
