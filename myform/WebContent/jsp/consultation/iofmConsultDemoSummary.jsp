...
<tr>
	<td colspan="2" align="left" valign="top" class="Boxoutline">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="left">
					<a href='<bean:message key="OIFM.contextroot" />/consultViewModifyPageAction.do?paperId=<bean:write name="ConsultPageForm" property="paperId" />&paperTitle=<%=strTitle%>&hiddenAction=summary&export=yes'>
