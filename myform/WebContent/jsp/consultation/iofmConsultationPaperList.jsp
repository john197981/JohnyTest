...
<%@ page language="java" import="java.util.ArrayList,com.oifm.consultation.OIFormConsultListingWeb"%>
...
.style2 {font-size: 11px}
	--> 
		...
		<td colspan="2" align="left" valign="top">
			<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				    <td class="body_detail_text" align="center">
						<bean:message key="OI.CONS.CURRENTPAPER_NOT.AVAIL" />
					</td>
				</tr>
			</table>
		</td>
	...
	<%
	ArrayList al=null;
	if(request.getAttribute("ConsultListingFormWeb")!=null){
		OIFormConsultListingWeb objForm = (OIFormConsultListingWeb)request.getAttribute("ConsultListingFormWeb");
		if(objForm!=null){
		 al = (ArrayList)objForm.getArOIBVPaperPresent();
		if(al!=null){ %>
	...
	%>
		...
		<logic:notPresent name="ConsultListingFormWeb" property="arOIBVPaperPast" scope="request">
		<tr>
		<td colspan="2" align="left" valign="top">
			<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
				<tr>
				    <td class="body_detail_text" align="center">
						<bean:message key="OI.CONS.PASTPAPER_NOT.AVAIL" />
					</td>
				</tr>
			</table>
		</td>
	...
	if(request.getAttribute("ConsultListingFormWeb")!=null){
		OIFormConsultListingWeb objForm = (OIFormConsultListingWeb)request.getAttribute("ConsultListingFormWeb");
		if(objForm!=null){
		 al1 = (ArrayList)objForm.getArOIBVPaperPast();
		if(al1!=null){ %>
	...
	%>
		...
		<logic:present name="ConsultListingFormWeb" property="arOIBVPaperPresent" scope="request">
 			  <tr>
		...
		<logic:notPresent name="ConsultListingFormWeb" property="arOIBVPaperPresent" scope="request">
		<logic:present name="ConsultListingFormWeb" property="arOIBVPaperPast" scope="request">
 			  <tr>
			    <td><TABLE width="200" cellpadding="0" cellspacing="0">
                  <TBODY>
				  <TR><TD colspan="2" class="heading_thread"><u>Legend</u></TD></TR>
