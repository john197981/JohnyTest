...
var
  ...
  backColor = "#d1e1f8",                // background color of the ToC 
  normalColor = "#000000",        // text color of the ToC headlines
  lastVisitColor = "#CC00CC",        // text color of the line last visited
  currentColor = "#0000FF",        // text color of the actual line just clicked on
  ...
  textSizes = new Array(1.0, 0.7, 0.7, 0.7, 0.6),                        // font-size factors for: [0] the title "Table of Contents", [1] larger and bold fonts [2] smaller fonts if MS Internet Explorer [3] larger and bold fonts [4] smaller fonts if Netscape Navigator.
