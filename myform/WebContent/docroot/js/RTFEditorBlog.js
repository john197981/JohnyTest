...
this.imgURL = docRoot + '/images/editor/';
this.debug  = 0;
...
this.stylesheet = "/elsr_website/css/sp.css"; // full URL to stylesheet
...
*/  }
  ...
  // fgColor and bgColor
    ...
    var newcolor = showModalDialog(docRoot + "/html/select_color.html", oldcolor, "resizable: no; help: no; status: no; scroll: no;");
  ...
  // commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
    ...
    // insert image
      ...
      showModalDialog(docRoot + "/html/insert_image.html", editdoc, "resizable: no; help: no; status: no; scroll: no; ");
    }

    // insert table
    else if (cmdID.toLowerCase() == 'inserttable'){
      showModalDialog(docRoot + "/html/insert_table.html?"+objname,
                                 window,
                                 "resizable: yes; help: no; status: no; scroll: no; ");
    }
